# Bài 17. Cài đặt thuật toán tìm kiếm mẫu P trong đoạn văn bản T kết quả 
# trả về vị trí xuất hiện của mẫu P và số lần lặp tính toán, 
...
if __name__ == "__main__":
    # T = str(input("Nhap van ban T: "))
    # P = str(input("Nhap ban mau P: "))
    T = 'aaaaah '
    P = 'ah '
    print(failure(P))
    print(kmp(T, P))
